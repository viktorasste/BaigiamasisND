...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Pridėti naują vežimėlį</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form method="POST" action="{{route('stroller.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <div class="form-group">
                                ...
                                <select name="type" id="exampleType"
                                    ...
                                    <option value="normal">Vaikiški skėtuko formos</option>
                                    <option value="three">Triračiai vaikiški vežimėliai</option>
                                    <option value="double">Dvynukams skirti vežimėliai</option>
                                    <option value="sport">Sportiniai vežimėliai vaikams</option>
                                    <option value="universal">Universalūs vaikiški vežimėliai</option>
                                </select>
                                @error('type')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
