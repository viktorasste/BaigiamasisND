            ...
            @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        @endif
                        <a class="dropdown-item" href="{{ route('reservation.list') }}">{{ __('Mano rezervacijos') }}</a>
...
<div class="nav_bar">
    <header>
        <a href="{{route('index')}}"><img class="logo_pic" src="/images/301220021_519483296798508_1235047204078362737_n.jpg" alt=""></a>
    </header>
</div>
<div class="container">
    <div class="main">
...
@guest
    <div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalTitle"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('submit_login') }}" method="POST" style="display: contents;">
